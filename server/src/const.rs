...
pub const PERCENT_IS_WATER: u8 = 45;
...
pub const PERCENT_IS_MOUNTAINS: u8 = 99;
pub const COUNTS_TO_SPREAD_MOUNTAINS: u8 = 7;
pub const COUNTS_TO_SURVIVE_MOUNTAINS: u8 = 6;

pub const CA_ITER_HIGH_MOUNTAINS: usize = 7;
pub const PERCENT_IS_HIGH_MOUNTAINS: u8 = 30;
